...
class ReservationSQLModel:
    ...
    def create_reservation(self, reservation_id, client_id, room_number, start_date, end_date):
        self.__my_session.add(Reservations(reservation_id=reservation_id, client_id=client_id, room_number=room_number,
...
if __name__ == "__main__":
    ...
    model.create_reservation(reservation_id=10, client_id=321, room_number=4, start_date='20/04/21', end_date='22/04/21')
    model.update_reservation(reservation_id=10, client_id=123, room_number=7, start_date='20/05/21', end_date='23/05/21')
